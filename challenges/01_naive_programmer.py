...
class Contract(icontract.IContract):
    def setup(self, web3_contract):
        ...
        self.web3.transact_contract_method(web3_contract, self.contract_address, "SourceTrixAreFor1337", 0, [60, "Alice", "Bob"])
        ...
        self.web3.transact_contract_method(web3_contract, self.contract_address, "commitVote", 0, aliceVoteCommit)
        time.sleep(60)
        # revealVote(string memory _vote, bytes32 _voteCommit)
        #revealAbi = encode_abi(['string','bytes32'], [aliceVoteText, aliceVoteCommit])
        self.web3.transact_contract_method(web3_contract, self.contract_address, "revealVote", 0, [aliceVoteText, aliceVoteCommit])
